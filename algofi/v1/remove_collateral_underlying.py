...
def prepare_remove_collateral_underlying_transactions(sender, suggested_params, storage_account, amount, asset_id, manager_app_id, market_app_id, supported_market_app_ids, supported_oracle_app_ids):
